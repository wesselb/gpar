...
:math:`n \times p`, where :math:`p` is the number of outputs. To
condition GPAR on data without optimising its hyperparameters, use
...
.. |CI| image:: https://github.com/wesselb/gpar/workflows/CI/badge.svg?branch=master
   :target: https://github.com/wesselb/gpar/actions?query=workflow%3ACI
